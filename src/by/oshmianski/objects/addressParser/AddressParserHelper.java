...
public class AddressParserHelper {
    ...
    static {
        ...
        aliasValues.add(new AliasValueType("хутор", AddressParserItemTypeValue.city, "х"));
        ...
        aliasValues.add(new AliasValueType("тр-т", AddressParserItemTypeValue.street, "тракт"));
        ...
        aliasValues.add(new AliasValueType("вг", AddressParserItemTypeValue.street, "вг"));
        aliasValues.add(new AliasValueType("в\\г", AddressParserItemTypeValue.street, "вг"));
        ...
        aliasValues.add(new AliasValueType("п-к", AddressParserItemTypeValue.street, "переулок"));
        aliasValues.add(new AliasValueType("тракт", AddressParserItemTypeValue.street, "тракт"));
