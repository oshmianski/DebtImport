 ...
 */
public class TextFilterComponentStatus extends AbstractMatcherEditor implements FilterComponent<DataMainItem> {

    private static final TextFilterator<DataMainItem> ISSUE_TEXT_FILTERATOR = new FilteratorDataMainItemStatus();
    ...
    public TextFilterComponentStatus(final DockingContainer container) {
