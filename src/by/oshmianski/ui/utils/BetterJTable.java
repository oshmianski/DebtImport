...
//        TableCellRenderer renderer = table.getTableHeader().getDefaultRenderer();
        Component component = defaultRenderer.getTableCellRendererComponent(table, "", false, false, -1, 1);
...
//        return component;
    ...
    public static NiceScrollPane createStripedJScrollPane(JTable table) {
        NiceScrollPane scrollPane = new NiceScrollPane(table);
        scrollPane.setViewport(new StripedViewport(table));
        scrollPane.getViewport().setView(table);
        scrollPane.setBorder(BorderFactory.createEmptyBorder());
        scrollPane.setCorner(NiceScrollPane.UPPER_RIGHT_CORNER,
