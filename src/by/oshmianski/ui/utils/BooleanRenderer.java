...
public class BooleanRenderer extends DefaultTableCellRenderer implements TableCellRenderer {
    ...
    public BooleanRenderer(Color c, boolean isBold) {
        this(c, isBold, new DecimalFormat("###,##0"), -1);
    }

    public BooleanRenderer(Color c, boolean isBold, int swingConstantsAlign) {
        this(c, isBold, new DecimalFormat("###,##0"), swingConstantsAlign);
    }

    public BooleanRenderer(Color c, boolean isBold, DecimalFormat formatterNumber) {
        this(c, isBold, formatterNumber, -1);
    }

    public BooleanRenderer(Color c, boolean isBold, DecimalFormat formatterNumber, int swingConstantsAlign) {
        this.color = c;
        this.isBold = isBold;
